...
function sumArray(testArray) { //eslint-disable-line
    ...
    for (let i = 0; i < testArray.length; i++){
        let sum1 = sum(num,testArray[i])[0]
        num = sum1
    }
    return [num, testArray + " was passed in as an array of numbers, and " + num +  " is their sum." ]
}
...
function multiplyArray(multArr) { //eslint-disable-line
    ...
    for (let i = 0; i < multArr.length; i++){
        let multi1 = multiply(num,multArr[i])[0]
        num = multi1
    }
    return [num, "The numbers " + multArr + " have a product of " + num + "."]
}
...
function multiplyAnyArray(dynamicArray) { //eslint-disable-line
    ...
    for (let i = 0; i < dynamicArray.length; i++){
        let multi1 = multiply(num,dynamicArray[i])[0]
        num = multi1
    }
